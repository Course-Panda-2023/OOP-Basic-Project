...
ladyGaga.AddSong(gaga1);
christinaAguilera.AddSong(christina1);
madonna.AddSong(gaga1);
kesha.AddSong(gaga1);
britney.AddSong(gaga1);
kellyClarkson.AddSong(gaga1);
shakira.AddSong(gaga1);
katyPerry.AddSong(gaga1);
adele.AddSong(gaga1);
rihanna.AddSong(gaga1);
avrileLavigne.AddSong(gaga1);
beyonce.AddSong(gaga1);
nickiMinaj.AddSong(gaga1);
justinBieber.AddSong(gaga1);

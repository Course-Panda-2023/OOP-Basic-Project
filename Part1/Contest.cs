...
class Contest
{
    ...
    // returns the loser, so i can eliminate him from contest.
    public Singer SimulateRound()
    {
        ...
        Console.WriteLine(this.mFirstSinger.Name + " Sings: " + this.mFirstSinger.SongsList[firstIndex].SongName);
        Console.WriteLine(this.mSecondSinger.Name + " Sings: " + this.mSecondSinger.SongsList[secondIndex].SongName);
